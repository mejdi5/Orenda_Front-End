  ...
  return (
    <BrowserRouter>
      ...
      <Switch>
        ...
        <PrivateRoute path="/:_id" component={Profile} />
      </Switch>
      <footer style={{position:'fixed', bottom:'0%', width: '100%', textAlign:'center',  backgroundColor:'lightgray', height:'25px'}}>Copyright © 2021 All Rights Reserved </footer>
    </BrowserRouter>
  );
}
